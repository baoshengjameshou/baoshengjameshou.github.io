...
In my research, I apply machine learning (ML) and signal processing to model human behaviour as context for interaction, with a focus on novel eye-head-based interaction techniques. I chase a future where ML-enabled computing power augments human abilities, interfacing in naturally human ways.
